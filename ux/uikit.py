...
UITextInputTraits = ObjCProtocol('UITextInputTraits')
...
class UIUserInterfaceIdiom(Enum):
    unspecified = -1
    phone = 0
    pad = 1
    tv = 2
...
class UIUserInterfaceSizeClass(Enum):
    unspecified = 0
    compact = 1
    regular = 2

class UIUserInterfaceStyle(Enum):
    light = 1
    dark = 2
...
#UIKeyboardWillChangeNotification = objc_const(uikit, 'UIKeyboardWillChangeNotification')
...
WKWebpagePreferences = ObjCClass('WKWebpagePreferences')
