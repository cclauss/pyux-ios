...
def password_modal(sender):
    ...
    _actions = [[1, 'Add', 'none'], [2, 'Edit', 'checkmark'], [3, 'Delete', 'none']]
...
def login_callback(sender):
    ...
    _result = ux.login_alert('Login', 'Enter your credentials?', callback=_callback)
...
def confirm_callback(sender):
    ...
    _result = ux.confirm_dialog('Delete', 'Are you sure?', callback=_callback)
